...
function NavBar({isLogedIn}) {
  ...
  return (
    ...
    <h3 className="font-bold font-sans text-xl mx-4 p-4 ">
      ...
      <button className="font-bold relative left-48 shadow-md shadow-violet-400  bg-gradient-to-r from-white via-slate-300  to-white p-3 my-2 text-slate-600 rounded-lg text-md">Employee Login</button>
      </Link> : <Link to="/logout">
